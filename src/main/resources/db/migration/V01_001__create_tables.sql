...
CREATE INDEX editions ON dimensional_data_set (dataresource, major_label, minor_version);
CREATE UNIQUE INDEX versions ON dimensional_data_set (dataresource, major_version, minor_version);
