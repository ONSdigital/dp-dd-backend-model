...
CREATE INDEX editions ON dimensional_data_set (data_resource, major_label, minor_version);
CREATE UNIQUE INDEX versions ON dimensional_data_set (data_resource, major_version, minor_version);
